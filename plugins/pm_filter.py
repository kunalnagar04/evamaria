...
async def advantage_spell_chok(msg):
    ...
    if movielist:
        one_button = InlineKeyboardMarkup([[InlineKeyboardButton("🙂 Contact To My Owner", url="https://t.me/MH_Manager_04bot")]])
